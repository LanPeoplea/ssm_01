    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li><a href="https://github.com/LanPeoplea/ssm_01">GitHub</a></li>
                <li><a href="https://blog.csdn.net/qq_43622216">CSDN</a></li>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="user/queryall">查看信息</a></li>
                        <li><a href="user/toAdd">新增信息</a></li>
                        <li><a href="#">修改信息</a></li>
